      ...
      <div class="hero-body">
        <div class="container">
          <div class="th-logo has-text-centered">
           <img src="https://cdn.treehouseinternetgroup.com/cms_images/2535/CN%20Live%2025%20CMYK%20(1).png" alt="">
          </div>
...
<!----------------- Output Signature ---------------->       
 ...
 <!----------------- Modal ---------------->    
        ...
        <modal name="output" :height="415">
          ...
          <img src="https://cdn.treehouseinternetgroup.com/cms_images/2535/sign-copy4.gif" alt="">
        </div>
          </modal>
    </div>
    <hr>
